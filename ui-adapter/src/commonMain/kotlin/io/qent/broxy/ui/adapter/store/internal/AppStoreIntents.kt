    ...
    override fun updateAdapterMode(enabled: Boolean) {
        scope.launch {
            ...
            if (result.isFailure) {
                ...
                val presetId = state.snapshot.activeProxyPresetId ?: state.snapshot.selectedPresetId
                remoteConnector.notifyPresetChanged(presetId, RemotePresetChange.COMPOSITION)
            }
            publishReady()
        }
    }
