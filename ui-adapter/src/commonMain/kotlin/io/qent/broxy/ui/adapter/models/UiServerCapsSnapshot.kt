...
internal fun ServerCapsSnapshot.toUiModel(): UiServerCapsSnapshot = UiServerCapsSnapshot(
    serverId = serverId,
    name = name,
...
private fun ToolSummary.toUiModel(): UiToolSummary = UiToolSummary(
    name = name,
    description = description,
    arguments = arguments.map { it.toUiModel() }
)

private fun PromptSummary.toUiModel(): UiPromptSummary = UiPromptSummary(
    name = name,
    description = description,
    arguments = arguments.map { it.toUiModel() }
)

private fun ResourceSummary.toUiModel(): UiResourceSummary = UiResourceSummary(
    key = key,
    name = name,
    description = description,
    arguments = arguments.map { it.toUiModel() }
...
private fun CapabilityArgument.toUiModel(): UiCapabilityArgument = UiCapabilityArgument(
    name = name,
    type = type,
    required = required
)
