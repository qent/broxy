...
Define logging sinks, structured event contracts, and tracing expectations across proxy flows.

## When to read

- When adding/changing log event names or payload fields.
- When changing logger wiring in CLI/UI/headless.
- When debugging request routing or decode failures.
...
- `core/src/commonMain/kotlin/io/qent/broxy/core/utils/LogEventBuilder.kt`
- `core/src/jvmMain/kotlin/io/qent/broxy/core/proxy/inbound/SdkServerFactory.kt`

## Behavior contract

JSON event names and required payload keys in this file are compatibility-sensitive for diagnostics tooling.
