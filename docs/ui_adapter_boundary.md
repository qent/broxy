...
| --- | --- | --- |
| io.qent.broxy.core.config.ConfigurationManager | runtime | config mutation workflow (AppStore/AppStoreIntents) |
...
- `io.qent.broxy.core.config` only in AppStore/AppStoreIntents and JVM wiring
