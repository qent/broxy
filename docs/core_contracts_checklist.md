...
Quick verification checklist for compatibility-sensitive `core` contracts.

## When to read

- During reviews for core refactors.
- Before merging runtime/proxy/config contract changes.
...
Checklist mirrors `docs/core_contracts.md`; keep both in sync.
