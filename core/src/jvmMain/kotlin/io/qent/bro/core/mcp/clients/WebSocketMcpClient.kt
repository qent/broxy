...
class WebSocketMcpClient(
    ...
    override suspend fun connect(): Result<Unit> = runCatching {
        ...
        val sdk = requireNotNull(ktor).mcpWebSocket(urlString = url, requestBuilder = reqBuilder)
        client = RealSdkClientFacade(sdk)
        logger.info("Connected WebSocket MCP client to $url")
    }
    ...
    override suspend fun disconnect() {
        ...
        client = null
        ktor = null
        logger.info("Closed WebSocket MCP client for $url")
    }
