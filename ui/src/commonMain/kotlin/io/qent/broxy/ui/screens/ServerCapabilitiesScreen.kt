...
private fun CapabilitiesContent(
    ...
    val hasSearchableCapabilities = shouldShowCapabilitiesSearchField(caps)
...
internal fun shouldShowCapabilitiesSearchField(caps: UiServerCapsSnapshot): Boolean =
    caps.tools.isNotEmpty() || caps.prompts.isNotEmpty() || caps.resources.isNotEmpty()
